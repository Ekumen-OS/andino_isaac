...
## Contributing to andino_isaac

The following is a set of guidelines for contributing to andino_isaac project.
...
* **Which version of andino_isaac are you using?**?
* **What's the name and version of the OS you're using**?
* **Are you running andino_isaac using the provided docker container?** See [workspace setup](WORKSPACE_SETUP.md).
* **Are you running andino_isaac in a virtual machine?** If so, which VM software are you using and which operating systems and versions are used for the host and the guest?
...
* **Perform a** [cursory search](https://github.com/Ekumen-OS/andino_isaac/issues?q=is%3Aissue) to see if the enhancement has already been suggested. If it has, add a comment to the existing issue instead of opening a new one.
...
#. **Fork the andino_isaac package** you want to contribute to. This will create

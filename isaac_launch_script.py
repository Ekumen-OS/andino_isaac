...
parser.add_argument("--world_file", default="/home/aeneas/omniverse/andino_isaac/isaac_worlds/plain_world.usda", help="Full path to the world file")
parser.add_argument("--robot_file", default="/home/aeneas/omniverse/andino_isaac/andino_isaac_description/just_andino.usda", help="Full path to the robot file")

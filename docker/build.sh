...
function show_help() {
  ...
  Options:\n
  \t-i --image_name\t\t Name of the image to be built (default isaac_sim_ros2_humble_andino).\n
  Example:\n
  \tbuild.sh --image_name custom_image_name\n'
}

echo "Building the docker image for Isaac Sim ROS 2 humble andino development."
